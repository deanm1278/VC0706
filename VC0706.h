 ...
 *      Author: ladyada, modified by deanm1278
 *
 *      forked from the adafruit VC0706 library found here:
...
#define VC0706_SUCCESS_CODE             0x0
...
public:
	...
	bool TVoff();
	bool takePicture();
        int readPictureDMA(uint32_t n);     //output data via DMA instead
